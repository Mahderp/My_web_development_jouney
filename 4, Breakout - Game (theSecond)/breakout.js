...
//player
let playerWidth = 100; //normal = 80
let playerHeight = 10;
let playerVelocityX = 100; //normal = 10
...
function bottomCollision(ball, block) { //a is below block)
    return detectCollision(ball, block) && (block.height) >= ball.y;
}
